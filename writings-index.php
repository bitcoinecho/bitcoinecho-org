...
<head>
    ...
    <title>Writings — Bitcoin Echo</title>
    <meta name="description" content="Essays and analysis on Bitcoin, software permanence, and protocol design.">
    <meta name="theme-color" content="#0a0a0a">
    <link rel="icon" type="image/png" href="/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="/favicon-16x16.png" sizes="16x16" />

    <!-- Open Graph -->
    <meta property="og:title" content="Writings — Bitcoin Echo">
    <meta property="og:description" content="Essays and analysis on Bitcoin, software permanence, and protocol design.">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://bitcoinecho.org/writings">
        ...
        <div class="doc-grid">
            <a href="/writings/policy-vs-consensus" class="doc-card">
                ...
                <p class="doc-card-description">
                    The architectural separation that resolves Bitcoin's implementation wars. Why compile-time policy configuration is the technically correct answer.
                </p>
            </a>
        </div>
    </main>
